  ...
  const portfolioItems = [
    {
      ...
      image: project1,
      location: "Mumbai",
      description: "A tranquil living space designed with natural materials and soft lighting.",
      year: "2023",
      size: "450 sq.ft",
      likes: 124
    },
    {
      ...
      image: project2,
      location: "Delhi",
      description: "Clean lines and open spaces define this productive work environment.",
      year: "2022",
      size: "1200 sq.ft",
      likes: 89
    },
    {
      ...
      image: project3,
      location: "Bangalore",
      description: "Top-floor residence featuring panoramic views and premium finishes.",
      year: "2023",
      size: "3200 sq.ft",
      likes: 215
    },
    {
      ...
      image: project4,
      location: "Goa",
      description: "An inviting entrance space blending local craftsmanship with modern design.",
      year: "2021",
      size: "1800 sq.ft",
      likes: 156
    },
        ...
        <div className="row mb-4">
          <div className="col-12">
            <div className="d-flex justify-content-center flex-wrap">
              <button 
                className={`btn btn-outline-dark mx-2 mb-2 ${filter === "all" ? "active" : ""}`}
                onClick={() => setFilter("all")}
              >
                All Projects
              </button>
              <button 
                className={`btn btn-outline-dark mx-2 mb-2 ${filter === "residential" ? "active" : ""}`}
                onClick={() => setFilter("residential")}
              >
                Residential
              </button>
              <button 
                className={`btn btn-outline-dark mx-2 mb-2 ${filter === "commercial" ? "active" : ""}`}
                onClick={() => setFilter("commercial")}
              >
                Commercial
              </button>
              <button 
                className={`btn btn-outline-dark mx-2 mb-2 ${filter === "hospitality" ? "active" : ""}`}
                  ...
                  <div className="col-md-6">
                    ...
                    <ul className="list-group list-group-flush">
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        <span>Location:</span>
                        <span className="fw-medium">{selectedProject.location}</span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        <span>Category:</span>
                      ...
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        <span>Year:</span>
                        <span className="fw-medium">{selectedProject.year}</span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        <span>Size:</span>
                        <span className="fw-medium">{selectedProject.size}</span>
                      </li>
                      <li className="list-group-item d-flex justify-content-between align-items-center">
                        <span>Likes:</span>
                        <span className="fw-medium">
                          <FaHeart className="text-danger me-1" /> {selectedProject.likes}
                        </span>
                      </li>
                    </ul>
                  </div>
